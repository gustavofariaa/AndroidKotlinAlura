...
val appModules = module {
    ...
    single<NoticiaRepository> { NoticiaRepository(get(), get<NoticiaWebClient>()) }
    viewModel<ListaNoticiasViewModel> { ListaNoticiasViewModel(get<NoticiaRepository>()) }
    viewModel<FormularioNoticiaViewModel> { FormularioNoticiaViewModel(get<NoticiaRepository>()) }
    viewModel<VisualizaNoticiaViewModel> { (id: Long) ->
        VisualizaNoticiaViewModel(id, get<NoticiaRepository>())
    }
}